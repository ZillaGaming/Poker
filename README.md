...
<OL>
<LI>Fv3B = Fold versus Three Bet: The frequency the player raises then folds to re-raise. Represented as a percentage from 0 to 99. A value of 0 means that every time this player raises he has called a re-raise.
<LI>Fv3B = 0, This player hasn't folded after raising. The strategic adjustment made would be to only re-raise this player with high equity holdings. This player continues at a high frequency therefore increases the importance of equity.
